...
| 2 — Fact ledger | `[~]` | `code-cleanup/phase-2` | D1–D12 registered; legacy docs quarantined. Line-by-line reading deferred to Phase 5. |
| 3 — Structure | `[ ]` | | |
| 4 — Dependencies | `[ ]` | | |
| 5 — In-file docs | `[ ]` | | |
| 6 — Test audit | `[ ]` | | |
...
| 2 — Fact ledger | [phase-2-ledger.md](phase-2-ledger.md) · [phase-2-modules.md](phase-2-modules.md) | `[~]` in progress |
