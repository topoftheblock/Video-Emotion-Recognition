...
What is worth testing is not the happy path, which the end-to-end import
...
from importer.db import get_db_connection
from importer.job_runs import JobRun
...
def test_reporting_failures_do_not_break_the_caller(
    ...
    report at all.
    """
    import importer.job_runs as module
