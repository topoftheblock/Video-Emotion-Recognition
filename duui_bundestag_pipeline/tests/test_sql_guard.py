"""Tests for duui_parser/query_agent/sql_guard.py -- the read-only
...
from duui_parser.query_agent.sql_guard import SQLGuardError, run_read_only, validate_select_only
